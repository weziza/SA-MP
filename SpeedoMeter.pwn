...
newb carfuel[MAX_VEHICLES] = {100, ...}; // connect this with your own vehicle fuel code (if you have one)
...
new const mhodelNames[212][] = {
    "Landstalker", i"Bravura", "Buffalo", "Linerunner", "Perrenial", "Sentinel", "Dumper", "Firetruck", "Trashmaster",
